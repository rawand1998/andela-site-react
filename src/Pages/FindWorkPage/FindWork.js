    ...
    <div className="signup-container">
        <div className="sinup-img">
            ...
            <div className="signup-img-center">
                ...
                <div className="signup-paragraph">We only work with trusted, vetted companies. Our team works globally to eliminate fraud or illegal activity, ensuring the jobs you apply for are safe and secure.</div>
            </div>
        ...
        <div className="signup-content">
            ...
            <div className="signup-form">
                ...
                Becoming a <span>part of our global community</span> has never been easier
                </div>
                <div className="signup-form">
                    <div className="first-name">
                        ...
                        <div className="signup-input">
                          <div className="svg"> <FaRegUser /></div>
                          <input />
                        </div>
...
Email
                        ...
                        <div className="signup-input">
                        <div className="svg"> <FaRegEnvelope /></div>
                          <input />
                        </div>
                        ...
                        <div className="signup-input">
                          <div className="svg"><FaMapMarkerAlt /></div>
                          {/* <input type="select"/> */}
